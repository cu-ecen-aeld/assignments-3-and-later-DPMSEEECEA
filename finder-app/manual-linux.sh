...
#sudo cp -r "$FINDER_APP_DIR"/writer.o "$OUTDIR"/rootfs/home/
#sudo cp -r "$FINDER_APP_DIR"/writer.sh "$OUTDIR"/rootfs/home/
...
#sudo cp -r "$FINDER_APP_DIR"/conf/username.txt "$OUTDIR"/rootfs/home/conf
