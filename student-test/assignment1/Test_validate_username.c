...
void test_validate_my_username()
{
	...
	const char* hardcoded_username_from_conf_file = malloc_username_from_conf_file();
	TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_username, hardcoded_username_from_conf_file, "The two values are equal");
}
